...
export default async function handler(req, res) {
  const PRODUCT_ID = "dyLIMxujKq";      // 产品ID
  const DEVICE_NAME = "nbiot";          // 设备名
  const API_KEY = "version=2018-10-31&res=products%2FdyLIMxujKq%2Fdevices%2Fnbiot&et=1768250492&method=md5&sign=t5f1pNgczT2aSwuaUZ0ozQ%3D%3D"; // 北向API Key
